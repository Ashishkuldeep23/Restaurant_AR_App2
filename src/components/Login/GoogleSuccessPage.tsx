...
const GoogleSuccessPage = () => {
    ...
    const { isFullFilled, userData, isLoading } = userState()
    ...
    return (
        <>
            ...
            >
                <div className=" h-allAk mx-auto max-w-full lg:max-w-allAk px-1 lg:px-8 flex flex-col items-center pt-40">




                    <div className="border p-2 rounded text-center flex flex-col items-center justify-center">

                        <p className=" text-xl font-bold underline">User your google info to login</p>

                        <img className="w-32 h-32 my-3 rounded" src={userData.profilePic} alt={userData.firstName} />
